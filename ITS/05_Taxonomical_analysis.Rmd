...
subtitle: "05 Taxonomical analysis"
author: "Roey Angel"
...
#  fig.width = 12,
#  fig.height = 8,
  cache.path = "05_Taxonomy_cache/",
  fig.path = "05_Taxonomy_figures/"
)
...
### Reading in raw data
Read abundance table, taxonomic classification and metadata into a phyloseq object. Also remove sequences detected as contaminants in [04_Decontamination.html](04_Decontamination.html).
...
```{r Basidiomycota heatmap, cache=T}
Ps_obj_filt3_subset_ra %>% 
...
```{r Chytridiomycota heatmap, cache=T}
Ps_obj_filt3_subset_ra %>% 
...
```{r Mortierellomycota heatmap, cache=T}
Ps_obj_filt3_subset_ra %>% 
...
```{r Pleosporales heatmap, cache=T}
Ps_obj_filt3_subset_ra %>% 
